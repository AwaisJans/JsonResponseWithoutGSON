...
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_COMPLEX_MAP_KEYS;
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_DATE_PATTERN;
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_ESCAPE_HTML;
//import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_FORMATTING_STYLE;
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_JSON_NON_EXECUTABLE;
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_NUMBER_TO_NUMBER_STRATEGY;
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_OBJECT_TO_NUMBER_STRATEGY;
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_SERIALIZE_NULLS;
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_SPECIALIZE_FLOAT_VALUES;
//import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_STRICTNESS;
import static com.json.response.without.gson.app.utils.gson.Gson.DEFAULT_USE_JDK_UNSAFE;

//import com.json.response.without.gson.app.utils.errorprone.annotations.CanIgnoreReturnValue;
//import com.json.response.without.gson.app.utils.errorprone.annotations.InlineMe;
import com.json.response.without.gson.app.utils.gson.annotations.Since;
import com.json.response.without.gson.app.utils.gson.annotations.Until;
import com.json.response.without.gson.app.utils.gson.internal.$Gson$Preconditions;
import com.json.response.without.gson.app.utils.gson.internal.Excluder;
import com.json.response.without.gson.app.utils.gson.internal.bind.DefaultDateTypeAdapter;
import com.json.response.without.gson.app.utils.gson.internal.bind.TreeTypeAdapter;
...
public final class GsonBuilder {
  ...
  private com.json.response.without.gson.app.utils.gson.LongSerializationPolicy longSerializationPolicy = com.json.response.without.gson.app.utils.gson.LongSerializationPolicy.DEFAULT;
...
//  @CanIgnoreReturnValue
   ...
   * that do not have the {@link com.json.response.without.gson.app.utils.gson.annotations.Expose} annotation.
   *
   * <p>This is a convenience method which behaves as if an {@link ExclusionStrategy} which excludes
   * these fields was {@linkplain #setExclusionStrategies(ExclusionStrategy...) registered with this
   * builder}.
...
//      imports = "com.json.response.without.gson.app.utils.gson.Strictness")
//  @CanIgnoreReturnValue
...
//    boolean sqlTypesSupported = SqlTypesSupport.SUPPORTS_SQL_TYPES;
    boolean sqlTypesSupported = false;
