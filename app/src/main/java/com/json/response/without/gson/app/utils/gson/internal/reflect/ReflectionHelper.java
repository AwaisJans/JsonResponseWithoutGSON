...
package com.json.response.without.gson.app.utils.gson.internal.reflect;
  ...
  private static String getInaccessibleTroubleshootingSuffix(Exception e) {
    ...
    if (e.getClass().getName().equals("java.lang.reflect.InaccessibleObjectException")) {
      ...
      String troubleshootingId =
          message != null && message.contains("to module com.json.response.without.gson.app.utils.gson")
