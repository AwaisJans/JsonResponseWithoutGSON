...
import com.json.response.without.gson.app.utils.gson.internal.LinkedTreeMap;
...
//  @CanIgnoreReturnValue
  ...
  public void addProperty(String property, String value) {
    add(property, value == null ? JsonNull.INSTANCE : new com.json.response.without.gson.app.utils.gson.JsonPrimitive(value));
  }
   ...
   */
  public com.json.response.without.gson.app.utils.gson.JsonPrimitive getAsJsonPrimitive(String memberName) {
    return (com.json.response.without.gson.app.utils.gson.JsonPrimitive) members.get(memberName);
  }
