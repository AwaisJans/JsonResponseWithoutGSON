...
public interface JsonDeserializationContext {
  ...
  public <T> T deserialize(com.json.response.without.gson.app.utils.gson.JsonElement json, Type typeOfT) throws com.json.response.without.gson.app.utils.gson.JsonParseException;
}
