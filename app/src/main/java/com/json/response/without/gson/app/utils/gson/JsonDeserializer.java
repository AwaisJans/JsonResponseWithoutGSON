...
public interface JsonDeserializer<T> {
   ...
   */
  public T deserialize(com.json.response.without.gson.app.utils.gson.JsonElement json, Type typeOfT, JsonDeserializationContext context)
      throws com.json.response.without.gson.app.utils.gson.JsonParseException;
}
