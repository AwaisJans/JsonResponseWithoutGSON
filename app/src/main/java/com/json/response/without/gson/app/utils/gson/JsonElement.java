...
import com.json.response.without.gson.app.utils.gson.JsonArray;
...
public abstract class JsonElement {
  ...
  public boolean isJsonObject() {
    return this instanceof com.json.response.without.gson.app.utils.gson.JsonObject;
  }
  ...
  public boolean isJsonPrimitive() {
    return this instanceof com.json.response.without.gson.app.utils.gson.JsonPrimitive;
  }
  ...
  public boolean isJsonNull() {
    return this instanceof com.json.response.without.gson.app.utils.gson.JsonNull;
  }
   ...
   */
  public com.json.response.without.gson.app.utils.gson.JsonObject getAsJsonObject() {
    if (isJsonObject()) {
      return (com.json.response.without.gson.app.utils.gson.JsonObject) this;
    }
   ...
   * @throws IllegalStateException if this element is of another type.
   */
  public com.json.response.without.gson.app.utils.gson.JsonPrimitive getAsJsonPrimitive() {
    if (isJsonPrimitive()) {
      return (com.json.response.without.gson.app.utils.gson.JsonPrimitive) this;
    }
...
//  @CanIgnoreReturnValue // When this method is used only to verify that the value is JsonNull
  public com.json.response.without.gson.app.utils.gson.JsonNull getAsJsonNull() {
    if (isJsonNull()) {
      return (com.json.response.without.gson.app.utils.gson.JsonNull) this;
    }
  ...
  public String toString() {
    try {
      ...
      // contains NaN
      jsonWriter.setStrictness(com.json.response.without.gson.app.utils.gson.Strictness.LENIENT);
